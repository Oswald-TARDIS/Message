...
/**
 * Provides the local service interface for t_message. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author mazhe
 * @see t_messageLocalServiceUtil
...
public interface t_messageLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link t_messageLocalServiceUtil} to access the t_message local service. Add custom service methods to {@link com.message.service.impl.t_messageLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
