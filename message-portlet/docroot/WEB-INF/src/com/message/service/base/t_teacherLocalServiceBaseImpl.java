...
import com.message.service.t_teacherLocalService;
...
/**
 * Provides the base implementation for the t_teacher local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.message.service.impl.t_teacherLocalServiceImpl}.
 * </p>
 *
 * @author mazhe
 ...
 * @generated
 */
public abstract class t_teacherLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements t_teacherLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.message.service.t_teacherLocalServiceUtil} to access the t_teacher local service.
	 */
	...
	@Override
	public t_teacher addt_teacher(t_teacher t_teacher)
		throws SystemException {
		t_teacher.setNew(true);

		return t_teacherPersistence.update(t_teacher);
	}
	 ...
	 */
	@Override
	public t_teacher createt_teacher(long teacherId) {
		return t_teacherPersistence.create(teacherId);
	}
	...
	@Override
	public t_teacher deletet_teacher(long teacherId)
		throws PortalException, SystemException {
		return t_teacherPersistence.remove(teacherId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public t_teacher deletet_teacher(t_teacher t_teacher)
		throws SystemException {
		return t_teacherPersistence.remove(t_teacher);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(t_teacher.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return t_teacherPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return t_teacherPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return t_teacherPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public t_teacher fetcht_teacher(long teacherId) throws SystemException {
		return t_teacherPersistence.fetchByPrimaryKey(teacherId);
	}
	 ...
	 */
	@Override
	public t_teacher gett_teacher(long teacherId)
		throws PortalException, SystemException {
		return t_teacherPersistence.findByPrimaryKey(teacherId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return t_teacherPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<t_teacher> gett_teachers(int start, int end)
		throws SystemException {
		return t_teacherPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int gett_teachersCount() throws SystemException {
		return t_teacherPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public t_teacher updatet_teacher(t_teacher t_teacher)
		throws SystemException {
		return t_teacherPersistence.update(t_teacher);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.message.model.t_teacher",
			t_teacherLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.message.model.t_teacher");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = t_teacherPersistence.getDataSource();
	...
	private t_teacherLocalServiceClpInvoker _clpInvoker = new t_teacherLocalServiceClpInvoker();
}